	...
	<nav class="navbar navbar-expand-lg bg-body-tertiary">
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				<div class="d-flex">
					<a href = "login" style="text-decoration: none !important; color: black !important; ">
						<span class="fa fa-user-circle" style="font-size: 24px"></span>${CurrentUser.name }
					</a>
					<a href = "home?isLoggedOut=true" style="text-decoration: none !important; color: black !important; ">
						<span class="fa fa-sign-out" style="font-size: 24px"></span>Logout
					</a>
				</div>
			</div>
		</div>
